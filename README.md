...
>
> 3. Query an internal-only subdomain from your workstation (any HTTPRoute attached to the internal gateway): `dig @${home-dns-server-ip} hubble.${bootstrap_cloudflare_domain}`. It should resolve to `${bootstrap_internal_ingress_addr}`.
